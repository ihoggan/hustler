...
## Current status: r44 — playable, validated

**Validation snapshot (r44, measured on nix5 and reproduced in a Linux
container):**
...
`hustler.py` is ~9,900 lines; `cushion_path.py` ~515. The game is two files,
