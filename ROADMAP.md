...
## Current status: r37.1 — playable, validated

**Validation snapshot (r37.1, measured on nix5 and reproduced in a Linux
container):**
...
`hustler.py` is ~8,800 lines; `cushion_path.py` ~515. The game is two files,
