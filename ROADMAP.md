...
## Current status: r43 — playable, validated

**Validation snapshot (r43, measured on nix5 and reproduced in a Linux
container):**
...
`hustler.py` is ~9,795 lines; `cushion_path.py` ~515. The game is two files,
