...
## Current status: r42 — playable, validated

**Validation snapshot (r42, measured on nix5 and reproduced in a Linux
container):**
...
`hustler.py` is ~9,585 lines; `cushion_path.py` ~515. The game is two files,
