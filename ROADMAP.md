...
## Current status: r70 — playable, validated

**Validation snapshot (r69, measured on nix5 and reproduced in a Linux
container):**
...
`hustler.py` is ~14,560 lines; `cushion_path.py` ~515. The game is two files,
