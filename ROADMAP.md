...
## Current status: r41 — playable, validated

**Validation snapshot (r41, measured on nix5 and reproduced in a Linux
container):**
...
`hustler.py` is ~9,220 lines; `cushion_path.py` ~515. The game is two files,
